...
DROP TABLE IF EXISTS TRIPDATA_GEO_ODDDATE;
CREATE TABLE TRIPDATA_GEO_ODDDATE (
	ID BIGSERIAL NOT NULL,
	pickup_datetime TIMESTAMP NOT NULL,
	dropoff_datetime TIMESTAMP NOT NULL,
	pickup_latitude REAL NOT NULL DEFAULT 0,
...
CREATE INDEX ON TRIPDATA_GEO_ODDDATE (ID, pickup_latitude, pickup_longitude, dropoff_latitude, dropoff_longitude,  sourceID);
---DROP TABLE IF EXISTS TRIPDATA_ODDDATE;
CREATE TABLE TRIPDATA_ODDDATE (
	ID BIGSERIAL NOT NULL,
	pickup_datetime TIMESTAMP NOT NULL,
	dropoff_datetime TIMESTAMP NOT NULL,
	PULocationID SMALLINT NOT NULL DEFAULT 0,
...
CREATE INDEX ON TRIPDATA_ODDDATE (ID, PULocationID, pickup_month, pickup_hour, traffic, isholiday, isweekend, sourceID);
